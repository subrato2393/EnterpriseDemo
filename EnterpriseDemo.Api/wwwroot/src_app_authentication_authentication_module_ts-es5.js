(function () {
  ...
  (self["webpackChunksmart"] = self["webpackChunksmart"] || []).push([["src_app_authentication_authentication_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function Page500Component_ng_container_19_Template(rf, ctx) {
        if (rf & 1) {
      ...
      _Page500Component.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 20,
        vars: 1,
        consts: [[1, "auth-container"], [1, "row", "auth-main"], [1, "col-sm-6", "px-0", "d-none", "d-sm-block"], [1, "left-img", 2, "background-image", "url(assets/images/pages/bg-05.png)"], [1, "col-sm-6", "auth-form-section"], [1, "form-section"], [1, "auth-wrapper"], [1, "error-header", "p-b-45"], [1, "error-subheader2", "p-b-5"], [1, "container-auth-form-btn", "mt-5"], ["mat-flat-button", "", "color", "primary", "type", "submit", 1, "auth-form-btn"], [1, "w-full", "p-t-15", "p-b-15", "text-center"], ["routerLink", "/authentication/signin", 1, "txt1"], [4, "ngIf"], [1, "text-danger"], [1, "mt-5", 2, "background-color", "whitesmoke"]],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _SigninComponent = /*#__PURE__*/function (_src_app_shared_Unsub) {
        ...
        function _SigninComponent(formBuilder, route, router, authService, snackBar) {
          var _this;
          ...
          value: function onSubmit() {
            ...
            if (this.authForm.invalid) {
              ...
              this.subs.sink = this.authService.login(this.f.email.value, this.f.password.value).subscribe(function (res) {
                if (res) {
                  _this2.snackBar.open('login successfull.', '', {
                    duration: 3000,
                    verticalPosition: 'bottom',
                    horizontalPosition: 'right',
                  ...
                  var role = _this2.authService.currentUserValue.role.trim();

                  var traineeId = _this2.authService.currentUserValue.traineeId.trim();

                  var branchId = _this2.authService.currentUserValue.branchId.trim();
                  ...
                  if (role === src_app_core_models_role__WEBPACK_IMPORTED_MODULE_0__.Role.All || role === src_app_core_models_role__WEBPACK_IMPORTED_MODULE_0__.Role.MasterAdmin) {
                    ...
                    _this2.router.navigate(['/admin/dashboard/school-dashboard']);
                  } else if (role === src_app_core_models_role__WEBPACK_IMPORTED_MODULE_0__.Role.Instructor) {
                    _this2.router.navigate(['/admin/dashboard/instructor-dashboard']);
                  } else if (role === src_app_core_models_role__WEBPACK_IMPORTED_MODULE_0__.Role.Student) {
                    _this2.router.navigate(['/admin/dashboard/trainee-dashboard']);
                  } else if (role === src_app_core_models_role__WEBPACK_IMPORTED_MODULE_0__.Role.InterSeeviceCourse) {
                    _this2.router.navigate(['/admin/dashboard/interservice-dashboard']);
                  } else if (role === src_app_core_models_role__WEBPACK_IMPORTED_MODULE_0__.Role.BNA) {
                    console.log("check");

                    _this2.router.navigate(['/admin/dashboard/bna-dashboard']);
                  } else {
                    _this2.router.navigate(['/authentication/signin']);
                  }

                  _this2.loading = false; //  }, 1000);
                } else {
      ...
      _SigninComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        ...
        template: function SigninComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("ngSubmit", function SigninComponent_Template_form_ngSubmit_11_listener() {
              return ctx.onSubmit();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function SigninComponent_Template_a_click_27_listener() {
              return ctx.hide = !ctx.hide;
            });

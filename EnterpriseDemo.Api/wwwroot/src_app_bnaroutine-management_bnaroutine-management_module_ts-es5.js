(function () {
  ...
  (self["webpackChunksmart"] = self["webpackChunksmart"] || []).push([["src_app_bnaroutine-management_bnaroutine-management_module_ts"], {
        ...
        _createClass(_BnaClassScheduleListComponent, [{
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item?').subscribe(function (result) {
              ...
              if (result) {
                _this3.BnaClassScheduleService["delete"](id).subscribe(function () {
                  _this3.getBnaClassSchedules();
        ...
        _createClass(_NewBnaClassScheduleComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.BnaClassScheduleService.find(+id).subscribe(function (res) {
                _this4.BnaClassScheduleForm.patchValue({
          ...
          value: function getselectedClassPeriod() {
            ...
            this.BnaClassScheduleService.getselectedClassPeriod().subscribe(function (res) {
              _this6.selectedClassPeriod = res;
            });
          }
        }, {
          ...
          value: function onSubmit() {
            ...
            if (id) {
              this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item').subscribe(function (result) {
                ...
                if (result) {
                  _this9.BnaClassScheduleService.update(+id, _this9.BnaClassScheduleForm.value).subscribe(function (response) {
                    _this9.router.navigateByUrl('/routine-management/bnaclassschedule-list');
        ...
        _createClass(_BNAExamScheduleListComponent, [{
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item').subscribe(function (result) {
              ...
              if (result) {
                _this11.BNAExamScheduleService["delete"](id).subscribe(function () {
                  _this11.getBNAExamSchedules();
        ...
        _createClass(_NewBNAExamScheduleComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.BNAExamScheduleService.find(+id).subscribe(function (res) {
                _this12.BNAExamScheduleForm.patchValue({
          ...
          value: function getselectedbnasubjectname() {
            ...
            this.BNAExamScheduleService.getselectedbnasubjectname().subscribe(function (res) {
              _this15.selectedsubjectname = res;
            });
          }
        }, {
          ...
          value: function onSubmit() {
            ...
            if (id) {
              this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item').subscribe(function (result) {
                ...
                if (result) {
                  _this17.BNAExamScheduleService.update(+id, _this17.BNAExamScheduleForm.value).subscribe(function (response) {
                    _this17.router.navigateByUrl('/routine-management/bnaexamschedule-list');
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "BnaRoutineManagementRoutingModule": function BnaRoutineManagementRoutingModule() {
          return (
            /* binding */
            _BnaRoutineManagementRoutingModule
          );
        }
        /* harmony export */
      ...
      var _BnaRoutineManagementRoutingModule = function _BnaRoutineManagementRoutingModule() {
        _classCallCheck(this, _BnaRoutineManagementRoutingModule);
      };

      _BnaRoutineManagementRoutingModule.ɵfac = function BnaRoutineManagementRoutingModule_Factory(t) {
        return new (t || _BnaRoutineManagementRoutingModule)();
      };

      _BnaRoutineManagementRoutingModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineNgModule"]({
        type: _BnaRoutineManagementRoutingModule
      });
      _BnaRoutineManagementRoutingModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineInjector"]({
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵsetNgModuleScope"](_BnaRoutineManagementRoutingModule, {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "BnaRoutineManagementModule": function BnaRoutineManagementModule() {
          return (
            /* binding */
            _BnaRoutineManagementModule
          );
        }
        /* harmony export */
      ...
      var _bnaroutine_management_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./bnaroutine-management-routing.module */
      14205);
      /* harmony import */
      ...
      /*! @angular/core */
      37716); //import { RoutineManagementRoutingModule } from './routine-management-routing.module';


      var _BnaRoutineManagementModule = function _BnaRoutineManagementModule() {
        _classCallCheck(this, _BnaRoutineManagementModule);
      };

      _BnaRoutineManagementModule.ɵfac = function BnaRoutineManagementModule_Factory(t) {
        return new (t || _BnaRoutineManagementModule)();
      };

      _BnaRoutineManagementModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineNgModule"]({
        type: _BnaRoutineManagementModule
      });
      _BnaRoutineManagementModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineInjector"]({
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵsetNgModuleScope"](_BnaRoutineManagementModule, {
        ...
        _createClass(_ClassPeriodListComponent, [{
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item').subscribe(function (result) {
              ...
              if (result) {
                _this19.ClassPeriodService["delete"](id).subscribe(function () {
                  _this19.getClassPeriods();
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function NewClassPeriodComponent_div_24_mat_option_7_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NewClassPeriodComponent_div_24_mat_error_8_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NewClassPeriodComponent_mat_option_34_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NewClassPeriodComponent_mat_error_35_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-error");
      ...
      function NewClassPeriodComponent_mat_error_41_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-error");
      ...
      function NewClassPeriodComponent_mat_option_49_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-option", 38);
      ...
      function NewClassPeriodComponent_mat_error_50_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-error");
      ...
      function NewClassPeriodComponent_div_70_mat_header_cell_7_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NewClassPeriodComponent_div_70_mat_cell_8_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NewClassPeriodComponent_div_70_mat_header_cell_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-header-cell", 57);
      ...
      function NewClassPeriodComponent_div_70_mat_cell_11_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-cell");
      ...
      function NewClassPeriodComponent_div_70_mat_header_cell_13_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-header-cell", 57);
      ...
      function NewClassPeriodComponent_div_70_mat_cell_14_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-cell");
      ...
      function NewClassPeriodComponent_div_70_mat_header_cell_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-header-cell", 57);
      ...
      function NewClassPeriodComponent_div_70_mat_cell_17_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-cell");
      ...
      function NewClassPeriodComponent_div_70_mat_header_cell_19_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-header-cell", 57);
      ...
      function NewClassPeriodComponent_div_70_mat_cell_20_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-cell");
      ...
      function NewClassPeriodComponent_div_70_mat_header_cell_22_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var _c0 = function _c0(a1) {
        return ["/bnaroutine-management/update-bnaclassperiod", a1];
      };

      function NewClassPeriodComponent_div_70_mat_cell_23_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function NewClassPeriodComponent_div_70_mat_cell_23_Template_button_click_4_listener($event) {
            return $event.stopPropagation();
          })("click", function NewClassPeriodComponent_div_70_mat_cell_23_Template_button_click_4_listener() {
      ...
      function NewClassPeriodComponent_div_70_mat_header_row_24_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelement"](0, "mat-header-row");
        }
      }

      function NewClassPeriodComponent_div_70_mat_row_25_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelement"](0, "mat-row");
        }
      }

      function NewClassPeriodComponent_div_70_Template(rf, ctx) {
        if (rf & 1) {
        ...
        _createClass(_NewClassPeriodComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.ClassPeriodService.find(+id).subscribe(function (res) {
                _this20.ClassPeriodForm.patchValue({
                  classPeriodId: res.classPeriodId,
                ...
                _this20.courseNameId = res.courseNameId;
              });
            } else {
          ...
          value: function intitializeForm() {
            ...
            this.ClassPeriodForm.get('course').valueChanges.subscribe(function (value) {
              _this21.getSelectedCourseAutocomplete(value); //console.log(this.courseDurationId+" "+this.courseNameId +" "+this.traineeId)
          ...
          value: function getSelectedCourseAutocomplete(cName) {
            ...
            this.CourseNameService.getSelectedCourseByName(cName).subscribe(function (response) {
              _this22.options = response;
              _this22.filteredOptions = response;
            });
          }
        }, {
          ...
          value: function getselectedbaseschools() {
            ...
            this.ClassPeriodService.getselectedbaseschools().subscribe(function (res) {
              _this23.selectedbaseschool = res;
            });
          }
        }, {
          ...
          value: function onCourseSelectionChangeGetPeriodList() {
            ...
            if (baseSchoolNameId != null && courseNameId != null) {
              this.ClassPeriodService.getSelectedPeriodBySchoolAndCourse(baseSchoolNameId, courseNameId).subscribe(function (res) {
                _this24.GetPeriodListByParameter = res;
                console.log(_this24.GetPeriodListByParameter);
              });
            }
          }
        }, {
          ...
          value: function getselectedbnaclassschedulestatus() {
            ...
            this.ClassPeriodService.getselectedbnaclassschedulestatus().subscribe(function (res) {
              _this25.selectedcoursestatus = res;
            });
          }
        }, {
          key: "getselectedcoursename",
          ...
          value: function onSubmit() {
            ...
            if (id) {
              this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item').subscribe(function (result) {
                ...
                if (result) {
                  _this28.ClassPeriodService.update(+id, _this28.ClassPeriodForm.value).subscribe(function (response) {
                    //this.router.navigateByUrl('/routine-management/add-classperiod');
                    _this28.reloadCurrentRoute();
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item').subscribe(function (result) {
              ...
              if (result) {
                _this29.ClassPeriodService["delete"](id).subscribe(function () {
                  _this29.onCourseSelectionChangeGetPeriodList();
        ...
        _createClass(_ClassRoutineListComponent, [{
          ...
          value: function getClassRoutines() {
            ...
            this.ClassRoutineService.getClassRoutines(this.paging.pageIndex, this.paging.pageSize, this.searchText).subscribe(function (response) {
              _this30.dataSource.data = response.items;
              _this30.paging.length = response.totalItemsCount;
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item').subscribe(function (result) {
              ...
              if (result) {
                _this31.ClassRoutineService["delete"](id).subscribe(function () {
                  _this31.getClassRoutines();
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function EditClassRoutineComponent_ng_container_67_th_1_Template(rf, ctx) {
        ...
        if (rf & 2) {
          var col_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]().$implicit;
        ...
        _createClass(_EditClassRoutineComponent, [{
          ...
          value: function getSubjectName(schoolName, courseName) {
            ...
            this.classRoutineService.getselectedSubjectNamesBySchoolAndCourse(schoolName, courseName).subscribe(function (res) {
              _this32.selectedsubjectname = res;
              console.log(_this32.selectedsubjectname);
            });
          }
        }, {
          ...
          value: function getEditedRoutineList(schoolId, durationId, courseId, weekId) {
            ...
            this.classRoutineService.getClassRoutineListByParams(schoolId, durationId, courseId, weekId).subscribe(function (res) {
              _this33.editedRoutineList = res;
              _this33.schoolName = _this33.editedRoutineList[0].baseSchoolName;
              _this33.CourseName = _this33.editedRoutineList[0].courseName;
              _this33.CourseTitle = _this33.editedRoutineList[0].courseDuration;
              _this33.weekName = _this33.editedRoutineList[0].courseWeek;
              console.log(_this33.editedRoutineList);

              _this33.clearList();

              _this33.getEditedRoutineListonClick();
            });
          }
        }, {
          key: "getControlLabel",
          ...
          value: function getModifiedRoutine(baseSchoolNameId, courseNameId, courseWeekId) {
            ...
            this.classRoutineService.getClassRoutineByCourseNameBaseSchoolNameSpRequest(baseSchoolNameId, courseNameId, courseWeekId).subscribe(function (res) {
              _this34.selectedRoutineByParametersAndDate = res;
              console.log("Routine by Sp request");

              for (var i = 0; i <= _this34.selectedRoutineByParametersAndDate.length; i++) {
                console.log("Date" + _this34.selectedRoutineByParametersAndDate[i]);
              }

              console.log(_this34.selectedRoutineByParametersAndDate);
              _this34.displayedColumns = _toConsumableArray(Object.keys(_this34.selectedRoutineByParametersAndDate[0]));
              console.log(_toConsumableArray(Object.keys(_this34.selectedRoutineByParametersAndDate[0])));
              console.log(_this34.selectedRoutineByParametersAndDate);
            });
          }
        }, {
          ...
          value: function onSubmit() {
            ...
            this.confirmService.confirm('Confirm Save message', 'Are You Sure Save This Records?').subscribe(function (result) {
              ...
              if (result) {
                _this35.classRoutineService.weeklyRoutineUpdate(JSON.stringify(_this35.EditedClassRoutineForm.value)).subscribe(function (response) {
                  _this35.getModifiedRoutine(_this35.schoolId, _this35.courseId, _this35.weekId);
        ...
        _createClass(_NewClassRoutineComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.ClassRoutineService.find(+id).subscribe(function (res) {
                _this36.ClassRoutineForm.patchValue({
                ...
                _this36.getselectedcoursedurationbyschoolname();

                _this36.getselectedbnasubjectname(editArr);
              });
            } else {
          ...
          value: function onWeekSelectionChangeGet(dropdown) {
            ...
            this.ClassRoutineService.getselectedSubjectNamesBySchoolAndCourse(this.schoolId, this.courseId).subscribe(function (res) {
              _this37.selectedsubjectname = res;
              console.log(_this37.selectedsubjectname);
            });
            ...
            if (this.schoolId != null && this.courseId != null) {
              this.ClassRoutineService.getClassRoutineByCourseNameBaseSchoolNameSpRequest(this.schoolId, this.courseId, this.weekId).subscribe(function (res) {
                ...
                console.log(_this37.selectedRoutineByParametersAndDate);
                console.log(_this37.schoolId + "-" + _this37.courseId);

                _this37.ClassRoutineService.getCourseInstructorByBaseSchoolNameAndCourseName(_this37.schoolId, _this37.courseId, _this37.durationId).subscribe(function (res) {
                  _this37.traineeListByBaseSchoolAndCourse = res;
                  console.log(res);
                });

                _this37.ClassPeriodService.getSelectedPeriodBySchoolAndCourse(_this37.schoolId, _this37.courseId).subscribe(function (res) {
                  _this37.periodListByBaseSchoolAndCourse = res;
                  console.log(res);
                });
              });
          ...
          value: function onSubjectNameSelectionChange(baseSchoolNameId, courseNameId, bnaSubjectNameId, courseDurationId) {
            ...
            if (baseSchoolNameId != null && courseNameId != null && bnaSubjectNameId != null) {
              ...
              this.ClassRoutineService.getTotalPeriodByParameterRequest(baseSchoolNameId, courseNameId, bnaSubjectNameId).subscribe(function (res) {
                _this38.totalPeriod = res;
                console.log("total period");
                console.log(_this38.totalPeriod);
              });
            }
            ...
            this.ClassRoutineService.getClassRoutineCountByParameterRequest(baseSchoolNameId, courseNameId, bnaSubjectNameId, courseDurationId).subscribe(function (res) {
              _this38.routineCount = res;

              _this38.ClassRoutineForm.get('classCountPeriod').setValue(_this38.routineCount);

              console.log("routine count");
              console.log(_this38.routineCount);
            });
            this.ClassRoutineService.getTotalPeriodByParameterRequest(baseSchoolNameId, courseNameId, bnaSubjectNameId).subscribe(function (res) {
              _this38.totalPeriod = res;

              _this38.ClassRoutineForm.get('subjectCountPeriod').setValue(_this38.totalPeriod);
            ...
            this.ClassRoutineService.getSelectedRoutineByParameters(baseSchoolNameId, courseNameId, bnaSubjectNameId).subscribe(function (res) {
              _this38.selectedRoutineByParameter = res; // this gives an object with dates as keys

              var groups = _this38.selectedRoutineByParameter.reduce(function (groups, game) {
              ...
              _this38.groupArrays = Object.keys(groups).map(function (date) {
                return {
                  date: date,
                  games: groups[date]
                };
          ...
          value: function getselectedbaseschools() {
            ...
            this.ClassRoutineService.getselectedbaseschools().subscribe(function (res) {
              _this39.selectedbaseschool = res;
            });
          }
        }, {
          ...
          value: function getselectedcoursedurationbyschoolname() {
            ...
            this.ClassRoutineService.getselectedcoursedurationbyschoolname(baseSchoolNameId).subscribe(function (res) {
              console.log(res);
              _this40.selectedcoursedurationbyschoolname = res;
            });
          }
        }, {
          key: "getselectedbnasubjectname",
          value: function getselectedbnasubjectname(dropdown) {
            ...
            this.ClassRoutineService.getSelectedCourseWeeks(baseSchoolNameId, courseDurationId, courseNameId).subscribe(function (res) {
              _this41.selectedWeek = res;
              console.log(_this41.selectedWeek);
            });
          }
        }, {
          ...
          value: function getselectedCourseModules() {
            ...
            this.ClassRoutineService.getselectedCourseModules().subscribe(function (res) {
              _this42.selectedCourseModule = res;
            });
          }
        }, {
          key: "getselectedcoursename",
          value: function getselectedcoursename() {
            ...
            this.ClassRoutineService.getselectedcoursename().subscribe(function (res) {
              _this43.selectedcoursename = res;
            });
          }
        }, {
          ...
          value: function reloadCurrentRoute() {
            ...
            this.router.navigateByUrl('/', {
              ...
              _this45.router.navigate([currentUrl]);
            });
          }
        }, {
          key: "onSubmit",
          value: function onSubmit() {
            ...
            if (id) {
              this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item').subscribe(function (result) {
                ...
                if (result) {
                  _this46.ClassRoutineService.update(+id, _this46.ClassRoutineForm.value).subscribe(function (response) {
                    _this46.reloadCurrentRoute();
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item').subscribe(function (result) {
              ...
              if (result) {
                _this47.ClassRoutineService["delete"](id).subscribe(function () {
                  _this47.reloadCurrentRoute();
        ...
        _createClass(_BnaClassScheduleService, [{
          ...
          value: function getBnaClassSchedules(pageNumber, pageSize, searchText) {
            ...
            return this.http.get(this.baseUrl + '/bna-class-schedule/get-bnaClassSchedules', {
              ...
              _this48.BnaClassSchedules = [].concat(_toConsumableArray(_this48.BnaClassSchedules), _toConsumableArray(response.body.items));
              _this48.BnaClassSchedulePagination = response.body;
              return _this48.BnaClassSchedulePagination;
            }));
          }
        }, {
          key: "find",
        ...
        _createClass(_BNAExamScheduleService, [{
          ...
          value: function getBNAExamSchedules(pageNumber, pageSize, searchText) {
            ...
            return this.http.get(this.baseUrl + '/bna-exam-schedule/get-bnaExamSchedules', {
              ...
              _this49.BNAExamSchedules = [].concat(_toConsumableArray(_this49.BNAExamSchedules), _toConsumableArray(response.body.items));
              _this49.BNAExamSchedulePagination = response.body;
              return _this49.BNAExamSchedulePagination;
            }));
          }
        }, {
          key: "find",
        ...
        _createClass(_ClassPeriodService, [{
          ...
          value: function getClassPeriods(pageNumber, pageSize, searchText) {
            ...
            return this.http.get(this.baseUrl + '/class-period/get-classPeriods', {
              ...
              _this50.ClassPeriods = [].concat(_toConsumableArray(_this50.ClassPeriods), _toConsumableArray(response.body.items));
              _this50.ClassPeriodPagination = response.body;
              return _this50.ClassPeriodPagination;
            }));
          }
        }, {
          key: "find",
        ...
        _createClass(_ClassRoutineService, [{
          ...
          value: function getClassRoutines(pageNumber, pageSize, searchText) {
            ...
            return this.http.get(this.baseUrl + '/class-routine/get-classRoutines', {
              ...
              _this51.ClassRoutines = [].concat(_toConsumableArray(_this51.ClassRoutines), _toConsumableArray(response.body.items));
              _this51.ClassRoutinePagination = response.body;
              return _this51.ClassRoutinePagination;
            }));
          }
        }, {
          ...
          value: function getClassRoutinesByCourseDurationId(pageNumber, pageSize, searchText, courseDurationId) {
            ...
            return this.http.get(this.baseUrl + '/class-routine/get-classRoutinesByCourseDurationId', {
              ...
              _this52.ClassRoutines = [].concat(_toConsumableArray(_this52.ClassRoutines), _toConsumableArray(response.body.items));
              _this52.ClassRoutinePagination = response.body;
              return _this52.ClassRoutinePagination;
            }));
          }
        }, {
        ...
        _createClass(_TraineeNominationService, [{
          ...
          value: function getTraineeNominationsByCourseDurationId(pageNumber, pageSize, searchText, courseDurationId) {
            ...
            return this.http.get(this.baseUrl + '/trainee-nomination/get-traineeNominationsByCourseDurationId', {
              ...
              _this53.TraineeNominations = [].concat(_toConsumableArray(_this53.TraineeNominations), _toConsumableArray(response.body.items));
              _this53.TraineeNominationPagination = response.body;
              return _this53.TraineeNominationPagination;
            }));
          }
        }, {
          ...
          value: function getTraineeNominations(pageNumber, pageSize, searchText) {
            ...
            return this.http.get(this.baseUrl + '/trainee-nomination/get-traineeNominations', {
              ...
              _this54.TraineeNominations = [].concat(_toConsumableArray(_this54.TraineeNominations), _toConsumableArray(response.body.items));
              _this54.TraineeNominationPagination = response.body;
              return _this54.TraineeNominationPagination;
            }));
          }
        }, {

...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "StudentDashboardService": function() { return /* binding */ StudentDashboardService; }
/* harmony export */ });
...
/* harmony import */ var src_app_routine_management_models_classroutinePagination__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/routine-management/models/classroutinePagination */ 22881);
...
class StudentDashboardService {
    ...
    getSpStudentInfoByTraineeId(id) {
        return this.http.get(this.baseUrl + '/dashboard/get-studentInfoByTraineeId?TraineeId=' + id).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
            return response;
        }));
    }
    ...
    getSelectedCourseModulesByCourseNameId(id) {
        return this.http.get(this.baseUrl + '/dashboard/get-selectedCourseModulesByCourseNameId?courseNameId=' + id).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
            return response;
        }));
    }
    ...
    getExamRoutineForStudentDashboard(id) {
        return this.http.get(this.baseUrl + '/dashboard/get-examRoutineInfoBySchoolId?courseDurationId=' + id).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
            return response;
        }));
    }
    getRoutineByCourseDurationId(schoolId, courseId, durationId) {
        return this.http.get(this.baseUrl + '/dashboard/get-routineInfoByTraineeIdForStudentDashboard?courseDurationId=' + durationId + '&courseNameId=' + courseId + '&baseSchoolNameId=' + schoolId).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
            return response;
        }));
    }
    getTdecQuestionGroupListBySp(schoolId, courseId, durationId) {
        return this.http.get(this.baseUrl + '/dashboard/get-tdecQuestionGroupListBySp?BaseSchoolNameId=' + schoolId + '&courseNameId=' + courseId + '&courseDurationId=' + durationId).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
            return response;
        }));
    }
    getTdecQuationGroupByParams(schoolId, courseId, durationId, subjectId) {
        return this.http.get(this.baseUrl + '/tdec-quation-group/get-tdecQuationGroupByParams?baseSchoolNameId=' + schoolId + '&courseNameId=' + courseId + '&courseDurationId=' + durationId + '&bnaSubjectNameId=' + subjectId).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
            return response;
        }));
    }
    getReadingMAterialInfoBySchoolAndCourse(baseSchoolNameId, courseNameId) {
        return this.http.get(this.baseUrl + '/dashboard/get-readingMAterialInfoBySchoolAndCourse?BaseSchoolNameId=' + baseSchoolNameId + '&CourseNameId=' + courseNameId).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
            return response;
        }));
    }
    ...
    getNoticeBySchoolId(schoolId, current) {
        return this.http.get(this.baseUrl + '/dashboard/get-noticeBySchoolId?BaseSchoolNameId=' + schoolId + '&CurrentDate=' + current).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
            return response;
        }));
    }
    getCurrentRoutineByTraineeId(courseDurationId) {
    ...
    getAttendanceByTraineeAndCourseDuration(traineeId, courseDurationId) {
        return this.http.get(this.baseUrl + '/dashboard/get-attendanceByTraineeAndCourseDuration?traineeId=' + traineeId + '&courseDurationId=' + courseDurationId).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
            return response;
        }));
    }
    getTraineeMarksheet(traineeId, courseDurationId) {
        return this.http.get(this.baseUrl + '/bna-exam-mark/get-markSheetByTraineeAndDurationandId?courseDurationId=' + courseDurationId + '&traineeId=' + traineeId).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
            return response;
        }));
    }
}
StudentDashboardService.ɵfac = function StudentDashboardService_Factory(t) { return new (t || StudentDashboardService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpClient)); };
StudentDashboardService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({ token: StudentDashboardService, factory: StudentDashboardService.ɵfac, providedIn: 'root' });

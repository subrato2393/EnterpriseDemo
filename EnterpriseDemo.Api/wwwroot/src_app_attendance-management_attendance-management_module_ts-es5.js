  ...
  (self["webpackChunksmart"] = self["webpackChunksmart"] || []).push([["src_app_attendance-management_attendance-management_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AttendanceManagementRoutingModule": function AttendanceManagementRoutingModule() {
          return (
            /* binding */
            _AttendanceManagementRoutingModule
          );
        }
        /* harmony export */
      ...
      var _AttendanceManagementRoutingModule = function _AttendanceManagementRoutingModule() {
        _classCallCheck(this, _AttendanceManagementRoutingModule);
      };

      _AttendanceManagementRoutingModule.ɵfac = function AttendanceManagementRoutingModule_Factory(t) {
        return new (t || _AttendanceManagementRoutingModule)();
      };

      _AttendanceManagementRoutingModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineNgModule"]({
        type: _AttendanceManagementRoutingModule
      });
      _AttendanceManagementRoutingModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_7__.RouterModule.forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_7__.RouterModule]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵsetNgModuleScope"](_AttendanceManagementRoutingModule, {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AttendanceManagementModule": function AttendanceManagementModule() {
          return (
            /* binding */
            _AttendanceManagementModule
          );
        }
        /* harmony export */
      ...
      var _attendance_management_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./attendance-management-routing.module */
      95386);
      /* harmony import */
      ...
      var _AttendanceApprovedComponent = /*#__PURE__*/function () {
        ...
        _createClass(_AttendanceApprovedComponent, [{
          ...
          value: function onClassPeriodSelectionChangeGetCourseDuration() {
            ...
            this.classRoutineService.getSelectedRoutineId(baseSchoolNameId, this.courseNameId, classPeriodId).subscribe(function (res) {
              _this3.classRoutineId = res;
            });

            if (baseSchoolNameId != null && courseNameId != null && classPeriodId != null) {
              this.AttendanceService.getSelectedCourseDurationByParameterRequestFromClassRoutine(baseSchoolNameId, this.courseNameId, classPeriodId).subscribe(function (res) {
                _this3.selectedCourseDurationByParameterRequest = res;

                _this3.traineeNominationService.getTraineeNominationByCourseDurationId(_this3.selectedCourseDurationByParameterRequest).subscribe(function (res) {
                  _this3.traineeNominationListForAttendance = res;
                });
              });
            }
            ...
            this.isShown = true;
            this.clearList();
            this.AttendanceService.getAttendanceListForUpdate(this.paging.pageIndex, this.paging.pageSize, this.searchText, baseSchoolNameId, this.courseNameId, classPeriodId).subscribe(function (response) {
              _this3.dataSource = response.items;
              _this3.paging.length = response.totalItemsCount;

              _this3.getTraineeListonClick();
          ...
          value: function onDateSelectionChange(event) {
            ...
            var date = this.datepipe.transform(event.value, 'MM/dd/yyyy'); //console.log(date);
            ...
            this.courseNameId = courseNameArr[1]; //console.log(courseNameArr);

            console.log(baseSchoolNameId + " -- " + this.courseNameId + " -- " + this.courseDurationId);

            if (baseSchoolNameId != null && this.courseNameId != null) {
              this.AttendanceService.getSelectedClassPeriodByBaseSchoolNameIdAndCourseNameIdforAttendances(baseSchoolNameId, this.courseNameId, this.courseDurationId, date).subscribe(function (res) {
                _this4.selectedClassPeriodByBaseSchoolNameIdAndCourseNameIdforAttendanceApprove = res;
                console.log(_this4.selectedClassPeriodByBaseSchoolNameIdAndCourseNameId);
              });
            }
          }
        }, {
          ...
          value: function getselectedclassroutine() {
            ...
            this.AttendanceService.getselectedclassroutine().subscribe(function (res) {
              _this5.selectedclassroutine = res;
            });
          }
        }, {
          ...
          value: function getselectedbnasubjectname() {
            ...
            this.AttendanceService.getselectedbnasubjectname().subscribe(function (res) {
              _this8.selectedbnasubjectname = res;
            });
          }
        }, {
          ...
          value: function getselectedclassperiod() {
            ...
            this.AttendanceService.getselectedclassperiod().subscribe(function (res) {
              _this9.selectedclassperiod = res;
            });
          }
        }, {
          ...
          value: function getselectedbnaattendanceremark() {
            ...
            this.AttendanceService.getselectedbnaattendanceremark().subscribe(function (res) {
              _this10.selectedbnaattendanceremark = res;
            });
          }
        }, {
          key: "onSubmit",
          value: function onSubmit() {
            ...
            var id = this.AttendanceForm.get('attendanceId').value; // if (id) {
            ...
            this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item').subscribe(function (result) {
              ...
              if (result) {
                ...
                _this11.AttendanceService.updateAttendanceList(JSON.stringify(_this11.AttendanceForm.value)).subscribe(function (response) {
                  _this11.router.navigateByUrl('/attendance-management/add-attendance');
        ...
        _createClass(_AttendanceInstructorComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.buttonText = "Update";
              this.AttendanceService.find(+id).subscribe(function (res) {
                _this12.AttendanceForm.patchValue({
                  attendanceId: res.attendanceId,
                  classRoutineId: res.classRoutineId,
                  baseSchoolNameId: res.baseSchoolNameId,
                  courseNameId: res.courseNameId,
          ...
          value: function getselectedclassperiod(traineeId) {
            ...
            this.AttendanceService.getSelectedClassPeriodForAttendanceInstructorBySpRequest(traineeId).subscribe(function (res) {
              _this13.selectedclassperiod = res;
              console.log("Seleted Class period");
              console.log(_this13.selectedclassperiod);
            });
          }
        }, {
          key: "onClassPeriodSelectionChangeGetCourseDuration",
          ...
          value: function getselectedbnaattendanceremark() {
            ...
            this.AttendanceService.getselectedbnaattendanceremark().subscribe(function (res) {
              _this15.selectedbnaattendanceremark = res;
            });
          }
        }, {
          key: "onSubmit",
            ...
            if (id) {
              this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item').subscribe(function (result) {
                ...
                if (result) {
                  ...
                  _this16.AttendanceService.updateAttendanceList(JSON.stringify(_this16.AttendanceForm.value)).subscribe(function (response) {
                    _this16.router.navigateByUrl('/attendance-management/add-attendance');
        ...
        _createClass(_AttendanceListComponent, [{
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item?').subscribe(function (result) {
              ...
              if (result) {
                _this18.AttendanceService["delete"](id).subscribe(function () {
                  _this18.getAttendances();
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function NewAttendanceComponent_div_26_mat_option_5_Template(rf, ctx) {
        if (rf & 1) {
        ...
        _createClass(_NewAttendanceComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.buttonText = "Update";
              this.AttendanceService.find(+id).subscribe(function (res) {
                _this19.AttendanceForm.patchValue({
                  attendanceId: res.attendanceId,
                  classRoutineId: res.classRoutineId,
                  baseSchoolNameId: res.baseSchoolNameId,
                  courseNameId: res.courseNameId,
          ...
          value: function onClassPeriodSelectionChangeGetCourseDuration() {
            ...
            this.classRoutineService.getSubjectNameFromRoutine(baseSchoolNameId, courseNameId, formatedDate, classPeriodId, this.courseDurationId).subscribe(function (res) {
              _this21.subjectNamefromClassRoutine = res;

              for (var i = 0; i < _this21.subjectNamefromClassRoutine.length; i++) {
                _this21.bnaSubjectNameId = _this21.subjectNamefromClassRoutine[i].value;
              }
            });
            this.classRoutineService.getSelectedRoutineIdFilter(baseSchoolNameId, courseNameId, classPeriodId, this.courseDurationId, formatedDate).subscribe(function (res) {
              _this21.classRoutineId = res;
              console.log("Class routine id");
              console.log(_this21.classRoutineId);
            });
            ...
            if (baseSchoolNameId != null && courseNameId != null && this.courseDurationId != null && classPeriodId != null) {
              this.traineeNominationService.getTraineeNominationByCourseDurationId(this.courseDurationId).subscribe(function (res) {
                _this21.traineeNominationListForAttendance = res;

                for (var i = 0; i <= _this21.traineeNominationListForAttendance.length; i++) {
                  _this21.traineeNominationListForAttendance[i].attendanceStatus = true;
                }
              });
            }
          }
          ...
          value: function onDateSelectionChange(event) {
            ...
            if (baseSchoolNameId != null && courseNameId != null && courseDurationId != null) {
              this.AttendanceService.getSelectedClassPeriodByBaseSchoolNameIdAndCourseNameId(baseSchoolNameId, courseNameId, courseDurationId, date).subscribe(function (res) {
                _this22.selectedClassPeriodByBaseSchoolNameIdAndCourseNameId = res;
                console.log(_this22.selectedClassPeriodByBaseSchoolNameIdAndCourseNameId);
              });
            }
          }
        }, {
          ...
          value: function getselectedcoursename() {
            ...
            this.AttendanceService.getselectedcoursename().subscribe(function (res) {
              _this25.selectedcoursename = res;
            });
          }
        }, {
          key: "getselectedbnasubjectname",
          value: function getselectedbnasubjectname() {
            ...
            this.AttendanceService.getselectedbnasubjectname().subscribe(function (res) {
              _this26.selectedbnasubjectname = res;
            });
          }
        }, {
          key: "getselectedclassperiod",
          value: function getselectedclassperiod() {
            ...
            this.AttendanceService.getselectedclassperiod().subscribe(function (res) {
              _this27.selectedclassperiod = res;
            });
          }
        }, {
          key: "getselectedbnaattendanceremark",
          value: function getselectedbnaattendanceremark() {
            ...
            this.AttendanceService.getselectedbnaattendanceremark().subscribe(function (res) {
              _this28.selectedbnaattendanceremark = res;
            });
          }
        }, {
          key: "onSubmit",
          value: function onSubmit() {
            ...
            if (id) {
              this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item').subscribe(function (result) {
                ...
                if (result) {
                  _this29.AttendanceService.update(+id, JSON.stringify(_this29.traineeNominationListForAttendance)).subscribe(function (response) {
                    _this29.router.navigateByUrl('/attendance-management/add-attendance');
              ...
              this.AttendanceService.submit(JSON.stringify(this.traineeNominationListForAttendance)).subscribe(function (response) {
                _this29.AttendanceForm.reset();

                _this29.AttendanceForm.get('attendanceId').setValue(0);
        ...
        _createClass(_BNAExamAttendanceListComponent, [{
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item').subscribe(function (result) {
              ...
              if (result) {
                _this31.BNAExamAttendanceService["delete"](id).subscribe(function () {
                  _this31.getBNAExamAttendances();
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function NewBNAExamAttendanceComponent_mat_header_cell_67_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NewBNAExamAttendanceComponent_mat_cell_68_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NewBNAExamAttendanceComponent_mat_header_cell_70_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-header-cell", 52);
      ...
      function NewBNAExamAttendanceComponent_mat_cell_71_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-cell");
      ...
      function NewBNAExamAttendanceComponent_mat_header_cell_73_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-header-cell", 52);
      ...
      function NewBNAExamAttendanceComponent_mat_cell_74_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-cell");
      ...
      function NewBNAExamAttendanceComponent_mat_header_cell_76_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-header-cell", 52);
      ...
      function NewBNAExamAttendanceComponent_mat_cell_77_mat_option_3_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-option", 51);
      ...
      function NewBNAExamAttendanceComponent_mat_cell_77_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-cell");
      ...
      function NewBNAExamAttendanceComponent_mat_header_cell_79_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-header-cell", 52);
      ...
      function NewBNAExamAttendanceComponent_mat_cell_80_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("change", function NewBNAExamAttendanceComponent_mat_cell_80_Template_mat_checkbox_change_1_listener($event) {
      ...
      function NewBNAExamAttendanceComponent_mat_header_cell_82_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NewBNAExamAttendanceComponent_mat_cell_83_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function NewBNAExamAttendanceComponent_mat_cell_83_Template_button_click_4_listener($event) {
            return $event.stopPropagation();
          })("click", function NewBNAExamAttendanceComponent_mat_cell_83_Template_button_click_4_listener() {
      ...
      function NewBNAExamAttendanceComponent_mat_header_row_84_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelement"](0, "mat-header-row");
        }
      }

      function NewBNAExamAttendanceComponent_mat_row_85_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var _NewBNAExamAttendanceComponent = /*#__PURE__*/function () {
        ...
        _createClass(_NewBNAExamAttendanceComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.BNAExamAttendanceService.find(+id).subscribe(function (res) {
                _this32.BNAExamAttendanceForm.patchValue({
          ...
          value: function getselectedbaseschools() {
            ...
            this.attendanceService.getselectedbaseschools().subscribe(function (res) {
              _this34.selectedbaseschools = res;
            });
          }
        }, {
          key: "onCourseNameSelectionChangeGetClassPeriod",
          ...
          value: function onClassPeriodSelectionChangeGetCourseDuration() {
            ...
            if (baseSchoolNameId != null && courseNameId != null && classPeriodId != null) {
              this.attendanceService.getSelectedCourseDurationByParameterRequestFromClassRoutine(baseSchoolNameId, courseNameId, classPeriodId).subscribe(function (res) {
                _this35.selectedCourseDurationByParameterRequest = res;

                _this35.traineeNominationService.getTraineeNominationByCourseDurationId(_this35.selectedCourseDurationByParameterRequest).subscribe(function (res) {
                  _this35.traineeNominationListForAttendance = res;

                  _this35.BNAExamAttendanceForm.get('traineeList').setValue(res);

                  console.log(_this35.BNAExamAttendanceForm.value);
                });
              });
            }
          }
          ...
          value: function getselectedbnasemesterduration() {
            ...
            this.BNAExamAttendanceService.getselectedbnasemesterduration().subscribe(function (res) {
              _this36.selectedbnasemesterduration = res;
            });
          }
        }, {
          ...
          value: function getselectedbnasemester() {
            ...
            this.BNAExamAttendanceService.getselectedbnasemester().subscribe(function (res) {
              _this37.selectedbnasemester = res;
            });
          }
        }, {
          ...
          value: function getselectebnaexamschedule() {
            ...
            this.BNAExamAttendanceService.getselectebnaexamschedule().subscribe(function (res) {
              _this39.selectebnaexamschedule = res;
            });
          }
        }, {
          key: "getselectedbnasubjectname",
          value: function getselectedbnasubjectname() {
            ...
            this.BNAExamAttendanceService.getselectedbnasubjectname().subscribe(function (res) {
              _this40.selectedbnasubjectname = res;
            });
          }
        }, {
          ...
          value: function onSubmit() {
            ...
            if (id) {
              this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item').subscribe(function (result) {
                ...
                if (result) {
                  _this42.BNAExamAttendanceService.update(+id, _this42.BNAExamAttendanceForm.value).subscribe(function (response) {
                    _this42.router.navigateByUrl('/attendance-management/bnaexamattendance-list');

                    _this42.snackBar.open('Information Updated Successfully ', '', {
                      duration: 2000,
                      verticalPosition: 'bottom',
                      horizontalPosition: 'right',
                      panelClass: 'snackbar-success'
                    ...
                    _this42.validationErrors = error;
                  });
                }
              });
            } else {
              this.BNAExamAttendanceService.submit(this.BNAExamAttendanceForm.value).subscribe(function (response) {
                ...
                _this42.snackBar.open('Information Inserted Successfully ', '', {
                  duration: 2000,
                  verticalPosition: 'bottom',
                  horizontalPosition: 'right',
                  panelClass: 'snackbar-success'
        ...
        _createClass(_BNAExamAttendanceService, [{
          ...
          value: function getBNAExamAttendances(pageNumber, pageSize, searchText) {
            ...
            return this.http.get(this.baseUrl + '/bna-exam-attendance/get-bnaExamAttendances', {
              ...
              _this43.BNAExamAttendances = [].concat(_toConsumableArray(_this43.BNAExamAttendances), _toConsumableArray(response.body.items));
              _this43.BNAExamAttendancePagination = response.body;
              return _this43.BNAExamAttendancePagination;
            }));
          }
        }, {
          key: "find",

        ...
        _createClass(_BNASubjectNameService, [{
          ...
          value: function getBNASubjectNames(pageNumber, pageSize, searchText, status) {
            ...
            return this.http.get(this.baseUrl + '/bna-subject-name/get-bnaSubjectNames', {
              ...
              _this.BNASubjectNames = [].concat(_toConsumableArray(_this.BNASubjectNames), _toConsumableArray(response.body.items));
              _this.BNASubjectNamePagination = response.body;
              return _this.BNASubjectNamePagination;
            }));
          }
        }, {
          key: "find",
        ...
        _createClass(_SubjectMarkService, [{
          ...
          value: function getSubjectMarks(pageNumber, pageSize, searchText) {
            ...
            return this.http.get(this.baseUrl + '/subject-mark/get-subjectmarks', {
              ...
              _this2.SubjectMarks = [].concat(_toConsumableArray(_this2.SubjectMarks), _toConsumableArray(response.body.items));
              _this2.SubjectMarkPagination = response.body;
              return _this2.SubjectMarkPagination;
            }));
          }
        }, {
          key: "find",
        ...
        _createClass(_CourseInstructorService, [{
          ...
          value: function getCourseInstructors(pageNumber, pageSize, searchText) {
            ...
            return this.http.get(this.baseUrl + '/course-instructor/get-courseInstructors', {
              ...
              _this3.CourseInstructors = [].concat(_toConsumableArray(_this3.CourseInstructors), _toConsumableArray(response.body.items));
              _this3.CourseInstructorPagination = response.body;
              return _this3.CourseInstructorPagination;
            }));
          }
        }, {

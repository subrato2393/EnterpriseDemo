(function () {
  ...
  (self["webpackChunksmart"] = self["webpackChunksmart"] || []).push([["default-src_app_inter-service-dashboard_dashboard_dashboard_component_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_InterServiceDashboard_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ../services/InterServiceDashboard.service */
      75515);
      /* harmony import */
      ...
      function DashboardComponent_mat_header_cell_13_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DashboardComponent_mat_cell_14_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DashboardComponent_mat_header_cell_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-header-cell", 32);
      ...
      function DashboardComponent_mat_cell_17_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-cell");
      ...
      function DashboardComponent_mat_header_cell_19_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-header-cell", 32);
      ...
      function DashboardComponent_mat_cell_20_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-cell");
      ...
      function DashboardComponent_mat_header_cell_22_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-header-cell", 32);
      ...
      function DashboardComponent_mat_cell_23_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-cell");
      ...
      function DashboardComponent_mat_header_cell_25_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-header-cell", 32);
      ...
      function DashboardComponent_mat_cell_26_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-cell");
      ...
      function DashboardComponent_mat_header_cell_28_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DashboardComponent_mat_cell_29_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DashboardComponent_mat_header_row_30_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "mat-header-row");
        }
      }

      function DashboardComponent_mat_row_31_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var _c4 = function _c4() {
        return ["/admin/dashboard/view-officerlist"];
      };

      var _c5 = function _c5() {
        return ["/admin/dashboard/view-runningcourses"];
      };
      ...
      var _DashboardComponent = /*#__PURE__*/function () {
        function _DashboardComponent(datepipe, interServiceDashboardService) {
        ...
        _createClass(_DashboardComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.getCourseDurationsByCourseType(); // this.getForeignCourseCount();
          ...
          value: function getCourseDurationsByCourseType() {
            ...
            this.interServiceDashboardService.getSpRunningForeignCourseDurationsByType(this.runningCourseType, currentDateTime).subscribe(function (response) {
              _this.interServiceCourses = response;
              console.log(_this.interServiceCourses);
            });
          }
        }, {
          key: "initializeEvents",
          value: function initializeEvents() {// this.dashboardService.getCourseDurationForEventCalendar().subscribe(res=>{
          ...
          value: function getSpCourseDurations(id) {
            ...
            if (this.courseTypeId == this.masterData.coursetype.LocalCourse) {// this.dashboardService.getSpCourseDurationsByType(this.courseTypeId,currentDateTime).subscribe(response => {   
              ...
              // })
            } else if (this.courseTypeId === this.masterData.coursetype.ForeignCourse) {// this.dashboardService.getSpForeignCourseDurationsByType(this.courseTypeId,currentDateTime).subscribe(response => {   
              //   this.upcomingForeignCourses=response;
              // })
            } else {// this.dashboardService.getSpCourseDurationsByType(this.courseTypeId,currentDateTime).subscribe(response => {   
          ...
          value: function getnominatedCourseListFromSpRequest() {
            var currentDateTime = this.datepipe.transform(new Date(), 'MM/dd/yyyy'); // this.dashboardService.getnominatedCourseListFromSpRequest(currentDateTime).subscribe(response => {   
          ...
          value: function getrunningCourseTotalOfficerListfromprocedure() {
            var currentDateTime = this.datepipe.transform(new Date(), 'MM/dd/yyyy'); // this.dashboardService.getrunningCourseTotalOfficerListfromprocedureRequest(currentDateTime, this.masterData.TraineeStatus.officer).subscribe(response => {         
          ...
          value: function getSpTotalTrainee() {// this.dashboardService.getSpTotalTraineeByTraineeStatus().subscribe(response => {   
            //   this.traineeCount=response
            // })
          }
        }, {
          key: "getSpSchoolCount",
          value: function getSpSchoolCount() {// this.dashboardService.getSpSchoolCount().subscribe(response => {   
          ...
          value: function getLocalCourseCount() {
            var currentDateTime = this.datepipe.transform(new Date(), 'MM/dd/yyyy'); // this.dashboardService.getSpRunningCourseDurationsByType(this.masterData.coursetype.LocalCourse,currentDateTime).subscribe(response => {           
          ...
          value: function getForeignCourseCount() {
            var currentDateTime = this.datepipe.transform(new Date(), 'MM/dd/yyyy'); // this.dashboardService.getSpRunningCourseDurationsByType(this.masterData.coursetype.ForeignCourse,currentDateTime).subscribe(response => {           
          ...
          value: function getIntServiceCount() {
            var currentDateTime = this.datepipe.transform(new Date(), 'MM/dd/yyyy'); // this.dashboardService.getSpRunningCourseDurationsByType(this.masterData.coursetype.InterService,currentDateTime).subscribe(response => {           
      ...
      _DashboardComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        decls: 92,
        vars: 18,
        consts: [[1, "content", "db-main"], [1, "container-fluid"], [1, "row", "p-t-15"], [1, "col-xl-9", "col-lg-9", "col-md-12", "col-sm-12", "db-event-calendar"], [1, "card"], [1, "body"], [1, "row", "dash-cd-m-0"], [1, "col-lg-6", "col-md-6", "col-sm-12", "col-xs-12", "div-class", "div-left"], [1, "rnc"], ["matSort", "", 1, "mat-cell", 3, "dataSource"], ["table", ""], ["matColumnDef", "ser"], ["mat-sort-header", "", 4, "matHeaderCellDef"], [4, "matCellDef"], ["matColumnDef", "courseName"], ["matColumnDef", "orgName"], ["matColumnDef", "durationFrom"], ["matColumnDef", "durationTo"], ["matColumnDef", "actions"], ["ngClass", "custom-action local", "class", "pr-0", 4, "matHeaderCellDef"], ["ngClass", "custom-action local", "class", "pr-0", 4, "matCellDef"], [4, "matHeaderRowDef"], [4, "matRowDef", "matRowDefColumns"], [1, "col-xl-3", "col-lg-3", "col-md-6", "col-sm-12"], [1, "header"], ["mat-button", "", 1, "header-dropdown", 3, "matMenuTriggerFor"], ["menu", "matMenu"], ["mat-menu-item", ""], [1, "full-width", "col-12"], [3, "routerLink"], [1, "upcoming-color"], [1, "calendar-color"], ["mat-sort-header", ""], ["ngClass", "custom-action local", 1, "pr-0"], ["mat-icon-button", "", "title", "Nomination", 1, "btn-tbl-nomination", 3, "routerLink"], ["aria-label", "Edit", 1, "col-white"]],
        template: function DashboardComponent_Template(rf, ctx) {
          ...
          if (rf & 2) {
            var _r15 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵreference"](41);
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "InterServiceDashboardService": function InterServiceDashboardService() {
          return (
            /* binding */
            _InterServiceDashboardService
          );
        }
        /* harmony export */
      ...
      var src_app_course_management_models_coursedurationPagination__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! src/app/course-management/models/coursedurationPagination */
      41313);
      /* harmony import */
      ...
      var _InterServiceDashboardService = /*#__PURE__*/function () {
        function _InterServiceDashboardService(http) {
          _classCallCheck(this, _InterServiceDashboardService);
        ...
        _createClass(_InterServiceDashboardService, [{
          key: "getSpInstructorInfoByTraineeId",
          value: function getSpInstructorInfoByTraineeId(id) {
            return this.http.get(this.baseUrl + '/dashboard/get-instructorInfoByTraineeId?TraineeId=' + id).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          ...
          value: function getSpCurrentRoutineForStudentDashboard(id) {
            return this.http.get(this.baseUrl + '/class-routine/get-upcommingClassesForInstructorDashboardSpRequest?traineeId=' + id).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          ...
          value: function getSpInstructorRoutineByTraineeId(id) {
            return this.http.get(this.baseUrl + '/dashboard/get-instructorRoutineByTraineeId?TraineeId=' + id).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          ...
          value: function getInstructorPendingExamEvaluation(id) {
            return this.http.get(this.baseUrl + '/dashboard/get-instructorPendingExamEvaluation?traineeId=' + id).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          ...
          value: function getStudentSubmittedAssignmentLists(instructorAssignmentId, baseSchoolNameId, courseNameId, courseDurationId, bnaSubjectNameId) {
            return this.http.get(this.baseUrl + '/instructor-assignments/get-studentSubmittedAssignmentList?instructorAssignmentId=' + instructorAssignmentId + '&baseSchoolNameId=' + baseSchoolNameId + '&courseNameId=' + courseNameId + '&courseDurationId=' + courseDurationId + '&BnaSubjectNameId=' + bnaSubjectNameId).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          ...
          value: function getSpInstructorSubject(baseSchoolNameId, courseNameId, courseDurationId, bnaSubjectNameId) {
            return this.http.get(this.baseUrl + '/bna-subject-name/get-instructorSubjectsByParameters?baseSchoolNameId=' + baseSchoolNameId + '&courseNameId=' + courseNameId + '&courseDurationId=' + courseDurationId + '&bnaSubjectNameId=' + bnaSubjectNameId).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          ...
          value: function getSpReadingMaterialByTraineeId(id) {
            return this.http.get(this.baseUrl + '/dashboard/get-readingMaterialByTraineeId?baseSchoolNameId=' + id).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          ...
          value: function getSpRunningForeignCourseDurationsByType(id, current) {
            return this.http.get(this.baseUrl + '/dashboard/get-runningForeignCourseDurationfromprocedure?courseTypeId=' + id + '&CurrentDate=' + current).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }]);

        return _InterServiceDashboardService;
      }();

      _InterServiceDashboardService.ɵfac = function InterServiceDashboardService_Factory(t) {
        return new (t || _InterServiceDashboardService)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpClient));
      };

      _InterServiceDashboardService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjectable"]({
        token: _InterServiceDashboardService,
        factory: _InterServiceDashboardService.ɵfac,
        providedIn: 'root'
      });
      /***/
    }

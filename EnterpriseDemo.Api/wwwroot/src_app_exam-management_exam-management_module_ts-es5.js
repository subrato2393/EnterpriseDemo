  ...
  (self["webpackChunksmart"] = self["webpackChunksmart"] || []).push([["src_app_exam-management_exam-management_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _c0 = function _c0(a1) {
        return ["/exam-management/update-bnaclasstest", a1];
      };
        ...
        _createClass(_BnaClassTestListComponent, [{
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item').subscribe(function (result) {
              ...
              if (result) {
                _this4.BnaClassTestService["delete"](id).subscribe(function () {
                  _this4.getBnaClassTests();
        ...
        _createClass(_NewBnaClassTestComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.BnaClassTestService.find(+id).subscribe(function (res) {
                _this5.BnaClassTestForm.patchValue({
            ...
            if (dropdown.isUserInput) {
              ...
              if (baseSchoolNameId != null && courseNameId != null) {
                this.bnaexammarkService.getSelectedSubjectNameByBaseSchoolNameIdAndCourseNameId(baseSchoolNameId, courseNameId, courseDurationId).subscribe(function (res) {
                  _this6.selectedSubjectNameByBaseSchoolNameIdAndCourseNameId = res;
                });
              }
              ...
              this.bnaexammarkService.getCourseDurationByBaseSchoolNameIdAndCourseNameId(baseSchoolNameId, courseNameId).subscribe(function (res) {
                _this6.selectedCourseDuration = res;

                _this6.traineeNominationService.getTraineeNominationByCourseDurationId(_this6.selectedCourseDuration).subscribe(function (res) {
                  _this6.traineeList = res;
                });
              });
            }
          }
          ...
          value: function getselectedcoursedurationbyschoolname() {
            ...
            this.bnaexammarkService.getselectedcoursedurationbyschoolname(baseSchoolNameId).subscribe(function (res) {
              _this8.selectedcoursedurationbyschoolname = res;
            });
          }
        }, {
          ...
          value: function getBnaSemesterDurations() {
            ...
            this.BnaClassTestService.getselectedBnaSemesterDurations().subscribe(function (res) {
              _this9.selectedSemesterDuration = res;
            });
          }
        }, {
          ...
          value: function getselectedbnasemester() {
            ...
            this.BnaClassTestService.getselectedbnasemester().subscribe(function (res) {
              _this10.selectedbnasemester = res;
            });
          }
        }, {
          ...
          value: function getsubjectCategory() {
            ...
            this.BnaClassTestService.getselectedsubjectCategory().subscribe(function (res) {
              _this11.selectedsubjectCategory = res;
            });
          }
        }, {
          ...
          value: function getbnaSubjectCurriculum() {
            ...
            this.BnaClassTestService.getselectedbnaSubjectCurriculum().subscribe(function (res) {
              _this12.selectedbnaSubjectCurriculum = res;
            });
          }
        }, {
          ...
          value: function getselectedbnasubjectname() {
            ...
            this.BnaClassTestService.getselectedbnasubjectname().subscribe(function (res) {
              _this13.selectedbnaSubjectName = res;
            });
          }
        }, {
          ...
          value: function getbnaClassTestType() {
            ...
            this.BnaClassTestService.getselectedbnaClassTestType().subscribe(function (res) {
              _this14.selectedbnaClassTestType = res;
            });
          }
        }, {
          key: "onSubmit",
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _c0 = function _c0(a1) {
        return ["/exam-management/update-bnaexaminstructorassign", a1];
      };
        ...
        _createClass(_BNAExamInstructorAssignListComponent, [{
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item').subscribe(function (result) {
              ...
              if (result) {
                _this16.BNAExamInstructorAssignService["delete"](id).subscribe(function () {
                  _this16.getBNAExamInstructorAssigns();
        ...
        _createClass(_NewBNAExamInstructorAssignComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.BNAExamInstructorAssignService.find(+id).subscribe(function (res) {
                _this17.BNAExamInstructorAssignForm.patchValue({
          ...
          value: function intitializeForm() {
            ...
            this.BNAExamInstructorAssignForm.get('traineeName').valueChanges.subscribe(function (value) {
              _this18.getSelectedTraineeByPno(value);
            });
          } //autocomplete
          ...
          value: function onBaseNameSelectionChangeGetModule(dropdown) {
            ...
            if (baseSchoolNameId != null && courseNameId != null) {
              this.ClassRoutineService.getSelectedCourseModuleByBaseSchoolNameIdAndCourseNameId(baseSchoolNameId, courseNameId).subscribe(function (res) {
                _this20.selectedCourseModuleByBaseSchoolAndCourseNameId = res;
              });
          ...
          value: function getselectedbaseschools() {
            ...
            this.ClassRoutineService.getselectedbaseschools().subscribe(function (res) {
              _this21.selectedbaseschool = res;
            });
          }
        }, {
          key: "getselectedcoursedurationbyschoolname",
          value: function getselectedcoursedurationbyschoolname() {
            ...
            this.ClassRoutineService.getselectedcoursedurationbyschoolname(baseSchoolNameId).subscribe(function (res) {
              _this22.selectedcoursedurationbyschoolname = res;
            });
          }
        }, {
          key: "getselectedbnasubjectname",
          value: function getselectedbnasubjectname() {
            ...
            this.ClassRoutineService.getselectedbnasubjectnamebyparameters(baseSchoolNameId, courseNameId, courseModuleId).subscribe(function (res) {
              _this23.selectedsubjectname = res;
            });
          }
        }, {
          ...
          value: function onParametersSelectGeInstructorList() {
            ...
            if (baseSchoolNameId != null && courseNameId != null && courseModuleId != null && bnaSubjectNameId != null) {
              this.BNAExamInstructorAssignService.getSelectedInstructorByParameters(baseSchoolNameId, courseNameId, courseModuleId, bnaSubjectNameId).subscribe(function (res) {
                _this25.selectedInstructorList = res;
                console.log(_this25.selectedInstructorList);
              });
            }
          }
        }, {
          ...
          value: function getselectedCourseModules() {
            ...
            this.ClassRoutineService.getselectedCourseModules().subscribe(function (res) {
              _this26.selectedCourseModule = res;
            });
          }
        }, {
          ...
          value: function getselectedbnainstructortype() {
            ...
            this.BNAExamInstructorAssignService.getselectedbnainstructortype().subscribe(function (res) {
              _this29.selectedinstructor = res;
            });
          }
        }, {
          ...
          value: function getselectedbnaclasssectionselection() {
            ...
            this.BNAExamInstructorAssignService.getselectedbnaclasssectionselection().subscribe(function (res) {
              _this30.selectedclassselect = res;
            });
          }
        }, {
          key: "onSubmit",
          value: function onSubmit() {
            ...
            var id = this.BNAExamInstructorAssignForm.get('bnaExamInstructorAssignId').value;
            ...
            if (id) {
              this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item').subscribe(function (result) {
                ...
                if (result) {
                  _this31.BNAExamInstructorAssignService.update(+id, _this31.BNAExamInstructorAssignForm.value).subscribe(function (response) {
                    _this31.router.navigateByUrl('/exam-management/add-bnaexaminstructorassign');
              ...
              this.BNAExamInstructorAssignService.submit(this.BNAExamInstructorAssignForm.value).subscribe(function (response) {
                ...
                _this31.BNAExamInstructorAssignForm.reset();
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item').subscribe(function (result) {
              ...
              if (result) {
                _this32.BNAExamInstructorAssignService["delete"](id).subscribe(function () {
                  _this32.onParametersSelectGeInstructorList();
      ...
      var _BNAExamMarkApproveComponent = /*#__PURE__*/function () {
        ...
        _createClass(_BNAExamMarkApproveComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.BNAExamMarkService.find(+id).subscribe(function (res) {
                _this33.BNAExamMarkForm.patchValue({
          ...
          value: function getselectedbaseschools() {
            ...
            this.BNAExamMarkService.getselectedbaseschools().subscribe(function (res) {
              _this34.selectedbaseschools = res; // console.log(this.selectedbaseschools);
            });
          }
        }, {
          ...
          value: function getselectedexammarkremark() {
            ...
            this.BNAExamMarkService.getselectedexammarkremark().subscribe(function (res) {
              _this35.selectedmarkremarks = res; // console.log(this.selectedbaseschools); 
            });
          }
        }, {
          key: "onCourseNameSelectionChangeGetSubjectAndTraineeList",
            ...
            if (dropdown.isUserInput) {
              ...
              if (baseSchoolNameId != null && courseNameId != null) {
                this.BNAExamMarkService.getApprovedSubjectNameByBaseSchoolNameIdAndCourseNameId(baseSchoolNameId, courseNameId, courseDurationId).subscribe(function (res) {
                  _this36.selectedSubjectNameByBaseSchoolNameIdAndCourseNameId = res;
                });
              }

              this.BNAExamMarkService.getCourseDurationByBaseSchoolNameIdAndCourseNameId(baseSchoolNameId, courseNameId).subscribe(function (res) {
                _this36.selectedCourseDuration = res;
                console.log("course duration " + _this36.selectedCourseDuration);
              });
            }
          }
        }, {
          ...
          value: function getselectedtraineebytype() {
            ...
            this.BNAExamMarkService.getexamMarkListByParameters(baseSchoolNameId, courseNameId, bnaSubjectNameId, SubjectMarkId, false).subscribe(function (res) {
              ...
              if (unapprovedlistItemCount > 0) {
                _this37.traineeList = res;
                _this37.ApproveMsgScreen = false;
                _this37.isShown = true;

                _this37.clearList();

                _this37.getTraineeListonClick();
              } else {
                _this37.isShown = false;
                _this37.ApproveMsgScreen = true;

                _this37.BNAExamMarkService.getexamMarkListByParameters(baseSchoolNameId, courseNameId, bnaSubjectNameId, SubjectMarkId, true).subscribe(function (response) {
                  var approvedlistItemCount = response.length;
                  console.log(approvedlistItemCount);

                  if (approvedlistItemCount > 0) {
                    _this37.ApproveMsg = "Records are already Approved!";
                    console.log(_this37.ApproveMsg);
                  } else {
                    _this37.ApproveMsg = "Marks are not isnerted Yet!";
                    console.log(_this37.ApproveMsg);
                  }
                });
              }
          ...
          value: function onSubjectNameSelectionChangeGetTotalMarkAndPassMark(dropdown) {
            ...
            if (dropdown.isUserInput) {
              ...
              this.BNAExamMarkService.GetRoutineIdWithSchoolCourseSubject(baseSchoolNameId, courseNameId, this.bnaSubjectNameId).subscribe(function (res) {
                _this38.classRoutineId = res;

                _this38.BNAExamMarkForm.get('classRoutineId').setValue(_this38.classRoutineId);
              });
              ...
              this.BNAExamMarkService.GetTotalMarkAndPassMarkByBaseSchoolIdCourseIdAndSubjectId(baseSchoolNameId, courseNameId, this.bnaSubjectNameId).subscribe(function (res) {
                _this38.getTotalMarkAndPassMark = res;
                _this38.totalMark = res[0].totalMark;
                _this38.passMarkBna = res[0].passMarkBNA;

                _this38.BNAExamMarkForm.get('totalMark').setValue(_this38.totalMark);

                _this38.BNAExamMarkForm.get('passMark').setValue(_this38.passMarkBna);
              });
            }
          }
        }, {
          ...
          value: function getselectedcoursedurationbyschoolname() {
            ...
            this.isShown = false;
            this.BNAExamMarkService.getselectedcoursedurationbyschoolname(baseSchoolNameId).subscribe(function (res) {
              _this39.selectedcoursedurationbyschoolname = res;
            });
          }
        }, {
          key: "getselectedcoursename",
          value: function getselectedcoursename() {
            ...
            this.BNAExamMarkService.getselectedcoursename().subscribe(function (res) {
              _this40.selectedcoursename = res;
            });
          }
        }, {
          ...
          value: function onSubmit() {
            ...
            this.confirmService.confirm('Confirm Save message', 'Are You Sure Save This Records?').subscribe(function (result) {
              ...
              if (result) {
                _this41.BNAExamMarkService.approve(JSON.stringify(_this41.BNAExamMarkForm.value)).subscribe(function (response) {
                  _this41.BNAExamMarkForm.reset();

                  _this41.isShown = false;

                  _this41.BNAExamMarkForm.get('isActive').setValue(true);

                  _this41.BNAExamMarkForm.get('isApproved').setValue(false);
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _c0 = function _c0(a1) {
        return ["/exam-management/update-bnaexammark", a1];
      };
        ...
        _createClass(_BNAExamMarkListComponent, [{
          ...
          value: function getBNAExamMarks() {
            ...
            this.BNAExamMarkService.getBNAExamMarks(this.paging.pageIndex, this.paging.pageSize, this.searchText).subscribe(function (response) {
              _this42.dataSource.data = response.items;
              _this42.paging.length = response.totalItemsCount;
          ...
          value: function deleteItem(row) {
            ...
            this.confirmService.confirm('Confirm delete message', 'Are You Sure Delete This Item').subscribe(function (result) {
              ...
              if (result) {
                _this43.BNAExamMarkService["delete"](id).subscribe(function () {
                  _this43.getBNAExamMarks();
        ...
        _createClass(_NewBNAExamMarkComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.buttonText = "Update";
              this.BNAExamMarkService.find(+id).subscribe(function (res) {
                _this44.BNAExamMarkForm.patchValue({
                  bnaExamMarkId: res.bnaExamMarkId,
                  bnaExamScheduleId: res.bnaExamScheduleId,
                  bnaSemesterId: res.bnaSemesterId,
                  bnaBatchId: res.bnaBatchId,
          ...
          value: function getselectedbaseschools() {
            ...
            this.BNAExamMarkService.getselectedbaseschools().subscribe(function (res) {
              _this45.selectedbaseschools = res; // console.log(this.selectedbaseschools);
            });
          }
        }, {
          key: "getselectedexammarkremark",
          value: function getselectedexammarkremark() {
            ...
            this.BNAExamMarkService.getselectedexammarkremark().subscribe(function (res) {
              _this46.selectedmarkremarks = res; // console.log(this.selectedbaseschools);
            });
          }
        }, {
          key: "onCourseNameSelectionChangeGetSubjectAndTraineeList",
          value: function onCourseNameSelectionChangeGetSubjectAndTraineeList(dropdown) {
            ...
            if (dropdown.isUserInput) {
              ...
              if (baseSchoolNameId != null && courseNameId != null) {
                this.BNAExamMarkService.getSelectedSubjectNameByBaseSchoolNameIdAndCourseNameId(baseSchoolNameId, courseNameId, courseDurationId).subscribe(function (res) {
                  _this47.selectedSubjectNameByBaseSchoolNameIdAndCourseNameId = res;
                });
              }

              this.BNAExamMarkService.getCourseDurationByBaseSchoolNameIdAndCourseNameId(baseSchoolNameId, courseNameId).subscribe(function (res) {
                _this47.selectedCourseDuration = res;

                _this47.traineeNominationService.getTestTraineeNominationByCourseDurationId(courseDurationId).subscribe(function (res) {
                  _this47.traineeList = res;
                  console.log(_this47.traineeList);
                });
              });
            }
          }
          ...
          value: function onSubjectNameSelectionChangeGetTotalMarkAndPassMark(dropdown) {
            ...
            if (dropdown.isUserInput) {
              ...
              this.BNAExamMarkService.GetSubjectMarkByBaseSchoolNameIdCourseNameAndSubjectNameId(baseSchoolNameId, courseNameId, this.bnaSubjectNameId).subscribe(function (res) {
                _this48.subjectMarkList = res;
                console.log("ddddddddddddd");
                console.log(_this48.subjectMarkList);
              });
              this.BNAExamMarkService.GetRoutineIdWithSchoolCourseSubject(baseSchoolNameId, courseNameId, this.bnaSubjectNameId).subscribe(function (res) {
                _this48.classRoutineId = res;

                _this48.BNAExamMarkForm.get('classRoutineId').setValue(_this48.classRoutineId);
              });
              this.BNAExamMarkService.getselectedmarktypes(baseSchoolNameId, courseNameId, this.bnaSubjectNameId, courseModuleId).subscribe(function (res) {
                _this48.selectedmarktype = res;
                _this48.examTypeCount = res.length;

                _this48.BNAExamMarkForm.get('examTypeCount').setValue(_this48.examTypeCount);

                console.log("selectedmarktype count" + _this48.examTypeCount);
              });
              this.BNAExamMarkService.GetTotalMarkAndPassMarkByBaseSchoolIdCourseIdAndSubjectId(baseSchoolNameId, courseNameId, this.bnaSubjectNameId).subscribe(function (res) {
                _this48.getTotalMarkAndPassMark = res;
                _this48.totalMark = res[0].totalMark;
                _this48.passMarkBna = res[0].passMarkBNA;

                _this48.BNAExamMarkForm.get('totalMark').setValue(_this48.totalMark);

                _this48.BNAExamMarkForm.get('passMark').setValue(_this48.passMarkBna);
              }); //  this.totalMark="";
              //  this.passMarkBna="";
            }
          }
          ...
          value: function getselectedcoursedurationbyschoolname() {
            ...
            this.BNAExamMarkService.getselectedcoursedurationbyschoolname(baseSchoolNameId).subscribe(function (res) {
              ...
              _this49.selectedcoursedurationbyschoolname = res;
            });
          }
        }, {
          key: "getselectedcoursename",
          value: function getselectedcoursename() {
            ...
            this.BNAExamMarkService.getselectedcoursename().subscribe(function (res) {
              _this50.selectedcoursename = res;
            });
          }
        }, {
          key: "onSubmit",
          value: function onSubmit() {
            ...
            if (id) {
              this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item?').subscribe(function (result) {
                ...
                if (result) {
                  _this51.BNAExamMarkService.update(+id, JSON.stringify(_this51.BNAExamMarkForm.value)).subscribe(function (response) {
                    _this51.router.navigateByUrl('/exam-management/bnaexammark-list');

                    _this51.snackBar.open('Information Updated Successfully ', '', {
                      duration: 2000,
                      verticalPosition: 'bottom',
                      horizontalPosition: 'right',
                      panelClass: 'snackbar-success'
                    ...
                    _this51.validationErrors = error;
                  });
                }
              });
            } else {
              this.confirmService.confirm('Confirm Save message', 'Are You Sure Save This Records?').subscribe(function (result) {
                ...
                if (result) {
                  _this51.BNAExamMarkService.submit(JSON.stringify(_this51.BNAExamMarkForm.value)).subscribe(function (response) {
                    //this.router.navigateByUrl('/exam-management/bnaexammark-list');
                    _this51.BNAExamMarkForm.reset();

                    _this51.isShown = false;

                    _this51.BNAExamMarkForm.get('bnaExamMarkId').setValue(0);

                    _this51.BNAExamMarkForm.get('isActive').setValue(true);

                    _this51.BNAExamMarkForm.get('isApproved').setValue(true);

                    _this51.snackBar.open('Information Inserted Successfully ', '', {
                      duration: 2000,
                      verticalPosition: 'bottom',
                      horizontalPosition: 'right',
                      panelClass: 'snackbar-success'
        ...
        _createClass(_NewBnaExammarkinstructor, [{
          ...
          value: function ngOnInit() {
            ...
            if (id) {
              ...
              this.buttonText = "Update";
              this.BNAExamMarkService.find(+id).subscribe(function (res) {
                _this52.BNAExamMarkForm.patchValue({
                  bnaExamMarkId: res.bnaExamMarkId,
                  bnaExamScheduleId: res.bnaExamScheduleId,
                  bnaSemesterId: res.bnaSemesterId,
                  bnaBatchId: res.bnaBatchId,
          ...
          value: function getselectedbaseschools() {
            ...
            this.BNAExamMarkService.getselectedbaseschools().subscribe(function (res) {
              _this53.selectedbaseschools = res;
            });
          }
        }, {
          key: "getselectedexammarkremark",
          value: function getselectedexammarkremark() {
            ...
            this.BNAExamMarkService.getselectedexammarkremark().subscribe(function (res) {
              _this54.selectedmarkremarks = res;
            });
          }
        }, {
          key: "onCourseNameSelectionChangeGetSubjectAndTraineeList",
            ...
            if (dropdown.isUserInput) {
              ...
              if (baseSchoolNameId != null && courseNameId != null) {
                this.BNAExamMarkService.getSelectedSubjectNameListForInstructorDashBoardByBaseSchoolNameIdAndCourseNameId(this.traineeId, baseSchoolNameId, courseDurationId).subscribe(function (res) {
                  _this55.selectedInstructorList = res;
                  console.log("instructor List");
                  console.log(_this55.selectedInstructorList);
                });
              }
              ...
              this.BNAExamMarkService.getCourseDurationByBaseSchoolNameIdAndCourseNameId(baseSchoolNameId, courseNameId).subscribe(function (res) {
                ...
                _this55.traineeNominationService.getTestTraineeNominationByCourseDurationId(courseDurationId).subscribe(function (res) {
                  _this55.traineeList = res;
                  console.log(_this55.traineeList);
                });
              });
            }
          }
          ...
          value: function onSubjectNameSelectionChangeGetTotalMarkAndPassMark(dropdown) {
            ...
            if (dropdown.isUserInput) {
              ...
              this.getTraineeListonClick();
              this.BNAExamMarkService.GetSubjectMarkByBaseSchoolNameIdCourseNameAndSubjectNameId(baseSchoolNameId, courseNameId, this.bnaSubjectNameId).subscribe(function (res) {
                _this56.subjectMarkList = res;
                console.log("ddddddddddddd");
                console.log(_this56.subjectMarkList);
              });
              this.BNAExamMarkService.GetRoutineIdWithSchoolCourseSubject(baseSchoolNameId, courseNameId, this.bnaSubjectNameId).subscribe(function (res) {
                _this56.classRoutineId = res;

                _this56.BNAExamMarkForm.get('classRoutineId').setValue(_this56.classRoutineId);
              });
              this.BNAExamMarkService.getselectedmarktypes(baseSchoolNameId, courseNameId, this.bnaSubjectNameId, courseModuleId).subscribe(function (res) {
                _this56.selectedmarktype = res;
                _this56.examTypeCount = res.length;

                _this56.BNAExamMarkForm.get('examTypeCount').setValue(_this56.examTypeCount);

                console.log("selectedmarktype count" + _this56.examTypeCount);
              });
              this.BNAExamMarkService.GetTotalMarkAndPassMarkByBaseSchoolIdCourseIdAndSubjectId(baseSchoolNameId, courseNameId, this.bnaSubjectNameId).subscribe(function (res) {
                _this56.getTotalMarkAndPassMark = res;
                _this56.totalMark = res[0].totalMark;
                _this56.passMarkBna = res[0].passMarkBNA;

                _this56.BNAExamMarkForm.get('totalMark').setValue(_this56.totalMark);

                _this56.BNAExamMarkForm.get('passMark').setValue(_this56.passMarkBna);
              });
            }
          }
        }, {
          ...
          value: function getselectedcoursedurationbyschoolname() {
            ...
            this.BNAExamMarkService.getselectedcoursedurationbyschoolname(baseSchoolNameId).subscribe(function (res) {
              console.log("check name");
              _this57.selectedcoursedurationbyschoolname = res;
            });
          }
        }, {
          key: "getselectedcoursename",
          ...
          value: function onSubmit() {
            ...
            if (id) {
              this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item?').subscribe(function (result) {
                ...
                if (result) {
                  _this59.BNAExamMarkService.update(+id, JSON.stringify(_this59.BNAExamMarkForm.value)).subscribe(function (response) {
                    _this59.router.navigateByUrl('/exam-management/bnaexammark-list');

                    _this59.snackBar.open('Information Updated Successfully ', '', {
                      duration: 2000,
                      verticalPosition: 'bottom',
                      horizontalPosition: 'right',
                      panelClass: 'snackbar-success'
              ...
              this.confirmService.confirm('Confirm Save message', 'Are You Sure Save This Records?').subscribe(function (result) {
                ...
                if (result) {
                  _this59.BNAExamMarkService.submit(JSON.stringify(_this59.BNAExamMarkForm.value)).subscribe(function (response) {
                    _this59.router.navigateByUrl('/admin/dashboard/instructor-dashboard');

                    _this59.BNAExamMarkForm.reset();

                    _this59.isShown = false;

                    _this59.BNAExamMarkForm.get('bnaExamMarkId').setValue(0);

                    _this59.BNAExamMarkForm.get('isActive').setValue(true);

                    _this59.BNAExamMarkForm.get('isApproved').setValue(true);
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ExamManagementRoutingModule": function ExamManagementRoutingModule() {
          return (
            /* binding */
            _ExamManagementRoutingModule
          );
        }
        /* harmony export */
      ...
      var _ExamManagementRoutingModule = function _ExamManagementRoutingModule() {
        _classCallCheck(this, _ExamManagementRoutingModule);
      };

      _ExamManagementRoutingModule.ɵfac = function ExamManagementRoutingModule_Factory(t) {
        return new (t || _ExamManagementRoutingModule)();
      };

      _ExamManagementRoutingModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineNgModule"]({
        type: _ExamManagementRoutingModule
      });
      _ExamManagementRoutingModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjector"]({
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵsetNgModuleScope"](_ExamManagementRoutingModule, {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ExamManagementModule": function ExamManagementModule() {
          return (
            /* binding */
            _ExamManagementModule
          );
        }
        /* harmony export */
      ...
      var _exam_management_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./exam-management-routing.module */
      26738);
      /* harmony import */
      ...
      var _ExamManagementModule = function _ExamManagementModule() {
        _classCallCheck(this, _ExamManagementModule);
      };

      _ExamManagementModule.ɵfac = function ExamManagementModule_Factory(t) {
        return new (t || _ExamManagementModule)();
      };

      _ExamManagementModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineNgModule"]({
        type: _ExamManagementModule
      });
      _ExamManagementModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineInjector"]({
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_10__.CommonModule, _exam_management_routing_module__WEBPACK_IMPORTED_MODULE_0__.ExamManagementRoutingModule, _angular_common__WEBPACK_IMPORTED_MODULE_10__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_11__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_11__.ReactiveFormsModule, _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_12__.NgxDatatableModule, _angular_material_table__WEBPACK_IMPORTED_MODULE_13__.MatTableModule, _angular_material_paginator__WEBPACK_IMPORTED_MODULE_14__.MatPaginatorModule, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_15__.MatFormFieldModule, _angular_material_input__WEBPACK_IMPORTED_MODULE_16__.MatInputModule, _angular_material_stepper__WEBPACK_IMPORTED_MODULE_17__.MatStepperModule, _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_18__.MatSnackBarModule, _angular_material_button__WEBPACK_IMPORTED_MODULE_19__.MatButtonModule, _angular_material_icon__WEBPACK_IMPORTED_MODULE_20__.MatIconModule, _angular_material_select__WEBPACK_IMPORTED_MODULE_21__.MatSelectModule, _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_22__.MatDatepickerModule, ngx_material_file_input__WEBPACK_IMPORTED_MODULE_23__.MaterialFileInputModule, _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_24__.MatAutocompleteModule]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵsetNgModuleScope"](_ExamManagementModule, {
        ...
        _createClass(_BnaClassTestService, [{
          ...
          value: function getBnaClassTests(pageNumber, pageSize, searchText) {
            ...
            return this.http.get(this.baseUrl + '/bna-class-test/get-bnaClassTests', {
              ...
              _this60.BnaClassTests = [].concat(_toConsumableArray(_this60.BnaClassTests), _toConsumableArray(response.body.items));
              _this60.BnaClassTestPagination = response.body;
              return _this60.BnaClassTestPagination;
            }));
          }
        }, {
          key: "find",

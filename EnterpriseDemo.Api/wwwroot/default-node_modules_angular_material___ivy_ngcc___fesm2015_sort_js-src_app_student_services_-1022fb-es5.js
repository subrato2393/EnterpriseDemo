(function () {
  ...
  (self["webpackChunksmart"] = self["webpackChunksmart"] || []).push([["default-node_modules_angular_material___ivy_ngcc___fesm2015_sort_js-src_app_student_services_-1022fb"], {
    /***/
    11494:
    /*!**********************************************************************!*\
    ...
    23250:
    /*!**************************************************************!*\
      !*** ./src/app/student/services/StudentDashboard.service.ts ***!
      \**************************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "StudentDashboardService": function StudentDashboardService() {
          return (
            /* binding */
            _StudentDashboardService
          );
        }
        /* harmony export */
      ...
      var src_app_routine_management_models_classroutinePagination__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! src/app/routine-management/models/classroutinePagination */
      22881);
      /* harmony import */
      ...
      var _StudentDashboardService = /*#__PURE__*/function () {
        function _StudentDashboardService(http) {
          _classCallCheck(this, _StudentDashboardService);

          this.http = http;
          this.baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl;
          this.SpstudentInfoByTraineeId = [];
          this.ClassRoutines = [];
          this.ClassRoutinePagination = new src_app_routine_management_models_classroutinePagination__WEBPACK_IMPORTED_MODULE_1__.ClassRoutinePagination();
        }

        _createClass(_StudentDashboardService, [{
          key: "getSpStudentInfoByTraineeId",
          value: function getSpStudentInfoByTraineeId(id) {
            return this.http.get(this.baseUrl + '/dashboard/get-studentInfoByTraineeId?TraineeId=' + id).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          key: "getStuffClgRoutine",
          value: function getStuffClgRoutine(pageNumber, pageSize, searchText, courseDurationId) {
            var _this5 = this;
            ...
            return this.http.get(this.baseUrl + '/class-routine/get-classRoutinesByCourseDurationId', {
              ...
              _this5.ClassRoutines = [].concat(_toConsumableArray(_this5.ClassRoutines), _toConsumableArray(response.body.items));
              _this5.ClassRoutinePagination = response.body;
              return _this5.ClassRoutinePagination;
            }));
          }
        }, {
          ...
          key: "getSelectedCourseModulesByCourseNameId",
          value: function getSelectedCourseModulesByCourseNameId(id) {
            return this.http.get(this.baseUrl + '/dashboard/get-selectedCourseModulesByCourseNameId?courseNameId=' + id).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          ...
          value: function getSelectedTdecActionStatus() {
            return this.http.get(this.baseUrl + '/tdec-action-status/get-selectedTdecActionStatus');
          }
        }, {
          key: "getAssignmentListForStudent",
          value: function getAssignmentListForStudent(current, schoolId, courseId, durationId) {
            return this.http.get(this.baseUrl + '/instructor-assignments/get-assignmentListForStudent?CurrentDate=' + current + '&baseSchoolNameId=' + schoolId + '&courseNameId=' + courseId + '&courseDurationId=' + durationId);
          }
        }, {
          key: "getQexamSubjectList",
          value: function getQexamSubjectList(branchId, courseNameId) {
          ...
          value: function getQexamRoutineByBranch(courseDurationId, branchId) {
            return this.http.get(this.baseUrl + '/class-routine/get-qexamRoutineByBranch?courseDurationId=' + courseDurationId + '&branchId=' + branchId);
          }
        }, {
          ...
          key: "getExamRoutineForStudentDashboard",
          value: function getExamRoutineForStudentDashboard(id) {
            return this.http.get(this.baseUrl + '/dashboard/get-examRoutineInfoBySchoolId?courseDurationId=' + id).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          key: "getRoutineByCourseDurationId",
          value: function getRoutineByCourseDurationId(schoolId, courseId, durationId) {
            return this.http.get(this.baseUrl + '/dashboard/get-routineInfoByTraineeIdForStudentDashboard?courseDurationId=' + durationId + '&courseNameId=' + courseId + '&baseSchoolNameId=' + schoolId).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          key: "getTdecQuestionGroupListBySp",
          value: function getTdecQuestionGroupListBySp(schoolId, courseId, durationId) {
            return this.http.get(this.baseUrl + '/dashboard/get-tdecQuestionGroupListBySp?BaseSchoolNameId=' + schoolId + '&courseNameId=' + courseId + '&courseDurationId=' + durationId).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          key: "getTdecQuationGroupByParams",
          value: function getTdecQuationGroupByParams(schoolId, courseId, durationId, subjectId) {
            return this.http.get(this.baseUrl + '/tdec-quation-group/get-tdecQuationGroupByParams?baseSchoolNameId=' + schoolId + '&courseNameId=' + courseId + '&courseDurationId=' + durationId + '&bnaSubjectNameId=' + subjectId).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          key: "getReadingMAterialInfoBySchoolAndCourse",
          value: function getReadingMAterialInfoBySchoolAndCourse(baseSchoolNameId, courseNameId) {
            return this.http.get(this.baseUrl + '/dashboard/get-readingMAterialInfoBySchoolAndCourse?BaseSchoolNameId=' + baseSchoolNameId + '&CourseNameId=' + courseNameId).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          key: "getTraineeMarkListByDurationAndId",
          value: function getTraineeMarkListByDurationAndId(courseDurationId, traineeId) {
            return this.http.get(this.baseUrl + '/bna-exam-mark/get-traineeMarkListByDurationandId?courseDurationId=' + courseDurationId + '&traineeId=' + traineeId);
          }
        }, {
          key: "getActiveBulletinList",
          value: function getActiveBulletinList(baseSchoolNameId) {
            return this.http.get(this.baseUrl + '/bulletin/get-activeBulletinList?baseSchoolNameId=' + baseSchoolNameId);
          }
        }, {
          key: "getNoticeBySchoolId",
          value: function getNoticeBySchoolId(schoolId, current) {
            return this.http.get(this.baseUrl + '/dashboard/get-noticeBySchoolId?BaseSchoolNameId=' + schoolId + '&CurrentDate=' + current).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          key: "getCurrentRoutineByTraineeId",
          value: function getCurrentRoutineByTraineeId(courseDurationId) {
            return this.http.get(this.baseUrl + '/dashboard/get-currentRoutineForStudentDashboardSpRequest?courseDurationId=' + courseDurationId);
          }
        }, {
          ...
          value: function getAttendanceByTraineeAndCourseDuration(traineeId, courseDurationId) {
            return this.http.get(this.baseUrl + '/dashboard/get-attendanceByTraineeAndCourseDuration?traineeId=' + traineeId + '&courseDurationId=' + courseDurationId).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }, {
          key: "getTraineeMarksheet",
          value: function getTraineeMarksheet(traineeId, courseDurationId) {
            return this.http.get(this.baseUrl + '/bna-exam-mark/get-markSheetByTraineeAndDurationandId?courseDurationId=' + courseDurationId + '&traineeId=' + traineeId).pipe((0, rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function (response) {
              return response;
            }));
          }
        }]);
      ...
      _StudentDashboardService.ɵfac = function StudentDashboardService_Factory(t) {
        return new (t || _StudentDashboardService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpClient));
      };

      _StudentDashboardService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
        token: _StudentDashboardService,
        factory: _StudentDashboardService.ɵfac,
        providedIn: 'root'
      });
      /***/
    }
